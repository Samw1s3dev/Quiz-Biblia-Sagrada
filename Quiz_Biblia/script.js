  ...
  const questionsBank = [
    {
      ...
      options: ["Adão", "Noé", "Moisés", "Abraão"],
      answer: "Adão"
    },
    {
      question: "Qual é o nome do jardim onde Deus colocou Adão e Eva?",
      options: ["Éden", "Babilônia", "Gólgota", "Jerusalém"],
      answer: "Éden"
    },
    {
    ...
    },
    {
      ...
      options: ["Mateus", "Pedro", "Tomé", "Tiago"],
      answer: "Mateus"
    },
    {
      question: "Qual é o nome do pai de José no Antigo Testamento?",
      options: ["Jacó", "Isaac", "Abraão", "Isaque"],
      answer: "Jacó"
    },
    {
    ...
    },
    {
      ...
      options: ["Jonas", "Noé", "Moisés", "Davi"],
      answer: "Jonas"
    },
    {
      question: "Quem sucedeu Moisés como líder dos israelitas?",
      options: ["Josué", "Calebe", "Arão", "Eli"],
      answer: "Josué"
    },
    {
      question: "Qual discípulo era irmão de André?",
      options: ["Pedro", "Tiago", "João", "Bartolomeu"],
      answer: "Pedro"
    },
    {
      question: "Qual das bem-aventuranças está no Sermão do Monte?",
      options: ["Bem-aventurados os humildes de espírito", "Bem-aventurados os ricos", "Bem-aventurados os fortes", "Bem-aventurados os líderes"],
